package java8tutorial.t2_learningTheJavaLanguage.c3_classesAndObjects.enumTypes;

// non solo c'e' una enum, invece di una classe...
// ma in realta' ogni enum estende java.lang.Enum, e quindi:
...
public enum Planet {
	...
	// ...c'e' pure un costruttore, per l'enum!!!
...
//		double earthWeight = Double.parseDouble(args[0]);
		double earthWeight = Double.parseDouble("101.12");
