...
(CODE AS DATA !!! ---> see https://www.youtube.com/watch?v=HeQX2HjkcNo)
...
public class RosterTest {
	...
	public static void printPersons3(List<Person> roster, CheckPerson tester) {
		for (Person p : roster) {
			if (tester.test(p)) {
				p.printPerson();
			}
	 ...
	 * is an anonymous class that filters members that are eligible for Selective
	 * Service in the United States: those who are male and between the ages of 18
	 * and 25:
	 */
//	 printPersons( 
//	 	roster, 
