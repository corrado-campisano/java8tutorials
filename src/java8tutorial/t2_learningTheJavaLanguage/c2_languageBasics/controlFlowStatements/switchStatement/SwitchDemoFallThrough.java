...
public class SwitchDemoFallThrough {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Current month number: " + month);
        ...
        if (futureMonths.isEmpty()) {
            System.out.println("futureMonths.isEmpty()... invalid month number: " + month + "?");
        } else {
        	System.out.println("Current and future months:");
